...
export default new Router({
  ...
  routes: [
    ...
    },
    {
      path: '/',
      name: 'layout',
      component: () => lazyLoadView(import(/* webpackChunkName: "layout" */ './views/Layout.vue')),
      children: [
        /* user */
        {
          path: '/user-setting',
